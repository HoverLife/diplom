...
- `model_results_technical_report.md` — технический отчёт по вашим фактическим output-метрикам с расчётами улучшений, формулами и готовыми абзацами для диплома.
